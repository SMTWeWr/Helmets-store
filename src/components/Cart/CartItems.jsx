...
const CartItems = React.memo(({name, imageUrl, size, totalPrice, totalCount, onRemoveItem, id, onPlusItem, onMinusItem}) => {
    const handleRemove = () => {
        onRemoveItem(id)
    }
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-remove">
                <Button className="button button--outline button--circle" onClick={handleRemove} outline>
